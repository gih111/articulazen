            ...
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
              ...
              <div className="w-full md:w-1/2">
                ...
                <p className="text-xl md:text-2xl font-bold text-white mb-4 md:mb-6">
                  Ele não remedia, ele <span className="text-orange-100 bg-orange-700 px-2 rounded">RESOLVE</span>.  Garanta seu combo com até 61% de desconto. Combos a partir de apenas 12x de R$ 10,60.
                </p>
